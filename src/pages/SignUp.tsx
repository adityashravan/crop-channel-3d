  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast.success('Account created successfully!', {
        description: 'Welcome to CropSense.',
      });
      navigate('/dashboard');
    }, 1500);
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/90 backdrop-blur-xl shadow-xl rounded-xl border border-gray-100 overflow-hidden animate-scale">
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Start managing your crops more efficiently</p>
              </div>
          ...
          <div className="mt-6 text-center animate-fade-in">
            <p className="text-xs text-gray-500">
              For demo purposes, you can use any details to create an account
            </p>
          </div>
        </div>
      </div>
